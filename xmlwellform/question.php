...
/**
 * xmlwellform question definition class.
 *
 * @package    qtype
...
include_once 'evaluation_xmlwellform.php';

/**
 * Represents a xmlwellform question.
 */
class qtype_xmlwellform_question extends question_graded_by_strategy
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseenterananswer', 'qtype_xmlwellform');
    }
...
//                $response['answer'], $answer->answer, !$this->usecase);
        $eval = new evaluation_xmlwellform();
