...
/**
 * Question type class for the xsdvalidator question type.
 *
...
/**
 * The xsdvalidator question type.
 *
 * @copyright 2013 Tim Hunt
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_xsdvalidator extends question_type {

    public function extra_question_fields() {
        return array('qtype_xsdvalidator_options', 'correctfeedback', 'correctfeedbackformat',
    ...
    public function save_question_options($question) {
        ...
        $options = $DB->get_record('qtype_xsdvalidator_options',
        ...
        if (!$options) {
            ...
            $options->id = $DB->insert_record('qtype_xsdvalidator_options', $options);
        }

        $options = $this->save_combined_feedback_helper($options, $question, $context, true);
        $DB->update_record('qtype_xsdvalidator_options', $options);
    ...
    public function get_possible_responses($questiondata) {
        ...
        foreach ($questiondata->options->answers as $answer) {
            ...
            $parts[$answer->id] = array(
                1 => new question_possible_response(get_string('matchesx', 'qtype_xsdvalidator', $answer->answer),
                        $shouldmatch / $numparts),
                0 => new question_possible_response(get_string('doesnotmatchex', 'qtype_xsdvalidator', $answer->answer),
                        (!$shouldmatch) / $numparts),
            );
        }
