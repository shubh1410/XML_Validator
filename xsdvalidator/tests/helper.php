...
/**
 * Test helpers for the xsdvalidator question type.
 *
...
/**
 * Test helper class for the xsdvalidator question type.
 *
 * @package   qtype_xsdvalidator
 * @copyright 2013 Tim Hunt
 */
class qtype_xsdvalidator_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frognottoad');
    }

    /**
     * Makes a xsdvalidator question where the student must match frog, but not toad.
     * @return qtype_xsdvalidator_question
     */
    public function make_xsdvalidator_question_frognottoad() {
        question_bank::load_question_definition_classes('xsdvalidator');
        $q = new qtype_xsdvalidator_question();
        ...
        $q->qtype = question_bank::get_qtype('xsdvalidator');

        return $q;
    }

    /**
     * Gets the question data for a xsdvalidator question where the student must match frog, but not toad.
     * @return stdClass
     */
    public function get_xsdvalidator_question_data_frognottoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'xsdvalidator';
    ...
    /**
     * Gets the form data for a xsdvalidator question where the student must match frog, but not toad.
     * @return stdClass
     */
    public function get_xsdvalidator_question_form_data_frognottoad() {
        $fromform = new stdClass();
        $fromform->penalty = 0.3333333;

        $fromform->qtype = 'xsdvalidator';
