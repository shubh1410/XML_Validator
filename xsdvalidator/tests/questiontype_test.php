...
/**
 * Unit tests for the xsdvalidator question type class.
 *
...
require_once($CFG->dirroot . '/question/type/xsdvalidator/questiontype.php');
 ...
 * @copyright 2013 Tim Hunt
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @group qtype_xsdvalidator
 */
class qtype_xsdvalidator_test extends question_testcase {

    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_xsdvalidator();
    }
    ...
    protected function get_test_question_data() {
        return test_question_maker::get_question_data('xsdvalidator');
    }

    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'xsdvalidator');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('xsdvalidator');
    ...
    public function test_get_possible_responses() {
        ...
        $this->assertEquals(array(
            13 => array(
                1 => new question_possible_response(get_string('matchesx', 'qtype_xsdvalidator', 'frog'), 0.5),
                0 => new question_possible_response(get_string('doesnotmatchex', 'qtype_xsdvalidator', 'frog'), 0),
            ),
            14 => array(
                1 => new question_possible_response(get_string('matchesx', 'qtype_xsdvalidator', 'toad'), 0),
                0 => new question_possible_response(get_string('doesnotmatchex', 'qtype_xsdvalidator', 'toad'), 0.5),
            ),
    ...
    public function test_xml_import() {
        $xml = '  <question type="xsdvalidator">
    <name>
    ...
    <hint>
      <text>Hint 2.</text>
        ...
        $expectedq = test_question_maker::get_question_form_data('xsdvalidator');
    ...
    public function test_xml_export() {
        $qdata = test_question_maker::get_question_data('xsdvalidator');

        $exporter = new qformat_xml();
        $xml = $exporter->writequestion($qdata);

        $expectedxml = '<!-- question: 0  -->
  <question type="xsdvalidator">
    <name>
      <text>Match frog but not toad</text>
    </name>
    <questiontext format="html">
