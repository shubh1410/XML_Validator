...
/**
 * Unit tests for the xsdvalidator question definition class.
 *
 ...
 */
class qtype_xsdvalidator_question_test extends advanced_testcase {

    public function test_is_complete_response() {
        $question = test_question_maker::make_question('xsdvalidator');
    ...
    public function test_get_question_summary() {
        $q = test_question_maker::make_question('xsdvalidator');
        $this->assertEquals(get_string('matchx', 'qtype_xsdvalidator', 'frog') . '; ' .
                get_string('dontmatchx', 'qtype_xsdvalidator', 'toad'), $q->get_question_summary());
    }
